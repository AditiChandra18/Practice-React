...
})({"h71zR":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "0c7a07a4624795c5";
"use strict";
...
},{}],"lNIYn":[function(require,module,exports) {
...
btn_click.addEventListener("click", function() {
    ...
    fetch("https://hplussport.com/api/products/").then((response)=>response.json()).then((data)=>{
    ...
    }).catch((error)=>output.textContent = `Error coming : ${error}`);
});

},{}]},["h71zR","1xC6H","lNIYn"], "lNIYn", "parcelRequire51ea")

//# sourceMappingURL=index.624795c5.js.map
